                                ...
                                <CardContent className="p-6 flex flex-col items-center text-center gap-4">
                                    <div className="relative">
                                        <Avatar className="h-24 w-24 ring-4 ring-primary/20">
                                            <AvatarImage src="https://lh3.googleusercontent.com/aida-public/AB6AXuAcHjvgw2NcP45qzQ6xCiLfeenAjTV8z9Up-rzqlLQCqzBFRjZ9oPwo-poABdkIWN7fw0BOEq3pOtPedIoLfDTqjbm2wD4GZV1tKCRf-n1bQqdIZWF55uzhPIqNrpDEOCrGgtHpocTnIwoke6FLjHpXZoP0B6Oi9GYpiux5SQveI7Z0AonUD7AZ_JXmeHLlbIl-dd5dBNkTn53EuwASxSI8ZNE885WQaK717FQilicr_p4geNcBJbsewH05E_fe3NsrdhcQzTTzLgM" alt="Alex Doe" />
                            ...
                            <Card className="shadow-sm">
                                ...
                                <CardContent className="p-6 pt-2">
                                    <div className="flex flex-wrap gap-2">
                                        ...
                                        {["Project Management", "Agile Methodologies"].map((skill) => (
